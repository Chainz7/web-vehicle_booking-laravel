...
Route::middleware(['auth'])->group(function () {
    Route::middleware(['role:2'])->group(function () {
        Route::prefix('approver')->group(function () {
            ...
            Route::get('/profile', 'App\Http\Controllers\ProfileController@indexApprover')->name('profileApprover.index');
            Route::post('/profileUpdate', 'App\Http\Controllers\ProfileController@updateApprover')->name('profileApprover.update');
